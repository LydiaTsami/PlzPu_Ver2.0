...
public class TrendingMoviesFragment extends Fragment implements IMoviesLoadedListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
        ...
        String url = BuildConfig.BASE_API_URL + "/movies/trending?page=" +page_count+ "&extended=full";
        getDataFromUrl(url);
